document.addEventListener("DOMContentLoaded", () => {
    const imagenBombilla = document.getElementById("miBombilla") as HTMLImageElement;
    const imagenInterruptor = document.getElementById("miInterruptor") as HTMLImageElement;
    const rotacionBar = document.getElementById("rotacion") as HTMLInputElement;
    ...
    // Control de tamaño
    const tamañoBar = document.getElementById("tamaño") as HTMLInputElement;
    ...
    const transpaBar = document.getElementById("transpa") as HTMLInputElement;
